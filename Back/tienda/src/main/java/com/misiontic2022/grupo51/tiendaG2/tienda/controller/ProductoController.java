...
import com.misiontic2022.grupo51.tiendaG2.tienda.repository.ProductoRepository;
...
public class ProductoController {
	...
	public ResponseEntity<List<Producto>> findByNombreproducto(@PathVariable("nombre") String nombre) {
		try {
